...
$temuan_kerusakan_foto_delete = NULL; // Initialize page object first

class ctemuan_kerusakan_foto_delete extends ctemuan_kerusakan_foto {
	...
	// Page object name
	var $PageObjName = 'temuan_kerusakan_foto_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("temuan_kerusakan_fotolist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in temuan_kerusakan_foto class, temuan_kerusakan_fotoinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("temuan_kerusakan_fotolist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($temuan_kerusakan_foto_delete)) $temuan_kerusakan_foto_delete = new ctemuan_kerusakan_foto_delete();

// Page init
$temuan_kerusakan_foto_delete->Page_Init();

// Page main
$temuan_kerusakan_foto_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$temuan_kerusakan_foto_delete->Page_Render();
?>
...
var CurrentForm = ftemuan_kerusakan_fotodelete = new ew_Form("ftemuan_kerusakan_fotodelete", "delete");

// Form_CustomValidate event
ftemuan_kerusakan_fotodelete.Form_CustomValidate = 
...
ftemuan_kerusakan_fotodelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $temuan_kerusakan_foto_delete->ShowPageHeader(); ?>
<?php
$temuan_kerusakan_foto_delete->ShowMessage();
?>
<form name="ftemuan_kerusakan_fotodelete" id="ftemuan_kerusakan_fotodelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($temuan_kerusakan_foto_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $temuan_kerusakan_foto_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="temuan_kerusakan_foto">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($temuan_kerusakan_foto_delete->RecKeys as $key) { ?>
...
<?php if ($temuan_kerusakan_foto->foto->Visible) { // foto ?>
		<th class="<?php echo $temuan_kerusakan_foto->foto->HeaderCellClass() ?>"><span id="elh_temuan_kerusakan_foto_foto" class="temuan_kerusakan_foto_foto"><?php echo $temuan_kerusakan_foto->foto->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$temuan_kerusakan_foto_delete->RecCnt = 0;
$i = 0;
while (!$temuan_kerusakan_foto_delete->Recordset->EOF) {
	$temuan_kerusakan_foto_delete->RecCnt++;
	$temuan_kerusakan_foto_delete->RowCnt++;

	// Set row properties
	$temuan_kerusakan_foto->ResetAttrs();
	$temuan_kerusakan_foto->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$temuan_kerusakan_foto_delete->LoadRowValues($temuan_kerusakan_foto_delete->Recordset);

	// Render row
	$temuan_kerusakan_foto_delete->RenderRow();
?>
	<tr<?php echo $temuan_kerusakan_foto->RowAttributes() ?>>
<?php if ($temuan_kerusakan_foto->foto->Visible) { // foto ?>
		<td<?php echo $temuan_kerusakan_foto->foto->CellAttributes() ?>>
<span id="el<?php echo $temuan_kerusakan_foto_delete->RowCnt ?>_temuan_kerusakan_foto_foto" class="temuan_kerusakan_foto_foto">
...
<?php
	$temuan_kerusakan_foto_delete->Recordset->MoveNext();
}
$temuan_kerusakan_foto_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $temuan_kerusakan_foto_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ftemuan_kerusakan_fotodelete.Init();
</script>
<?php
$temuan_kerusakan_foto_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$temuan_kerusakan_foto_delete->Page_Terminate();
?>
