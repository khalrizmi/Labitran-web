...
$kunjungan_view = NULL; // Initialize page object first

class ckunjungan_view extends ckunjungan {
	...
	// Page object name
	var $PageObjName = 'kunjungan_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "kunjunganlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "kunjunganlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "kunjunganlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($kunjungan_view)) $kunjungan_view = new ckunjungan_view();

// Page init
$kunjungan_view->Page_Init();

// Page main
$kunjungan_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$kunjungan_view->Page_Render();
?>
...
var CurrentForm = fkunjunganview = new ew_Form("fkunjunganview", "view");

// Form_CustomValidate event
fkunjunganview.Form_CustomValidate = 
...
fkunjunganview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fkunjunganview.Lists["x_nik"] = {"LinkField":"x_nik","Ajax":true,"AutoFill":false,"DisplayFields":["x_nik","x_nama","",""],"ParentFields":[],"ChildFields":["x_atmid"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"karyawan"};
fkunjunganview.Lists["x_nik"].Data = "<?php echo $kunjungan_view->nik->LookupFilterQuery(FALSE, "view") ?>";
fkunjunganview.Lists["x_atmid"] = {"LinkField":"x_atmid","Ajax":true,"AutoFill":false,"DisplayFields":["x_atmid","x_n_bank","x_n_atm","x_lokasi"],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"v_atm"};
fkunjunganview.Lists["x_atmid"].Data = "<?php echo $kunjungan_view->atmid->LookupFilterQuery(FALSE, "view") ?>";
...
<div class="ewToolbar">
<?php $kunjungan_view->ExportOptions->Render("body") ?>
<?php
	foreach ($kunjungan_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $kunjungan_view->ShowPageHeader(); ?>
<?php
$kunjungan_view->ShowMessage();
?>
<form name="fkunjunganview" id="fkunjunganview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($kunjungan_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $kunjungan_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="kunjungan">
<input type="hidden" name="modal" value="<?php echo intval($kunjungan_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($kunjungan->nik->Visible) { // nik ?>
	<tr id="r_nik">
		<td class="col-sm-2"><span id="elh_kunjungan_nik"><?php echo $kunjungan->nik->FldCaption() ?></span></td>
		<td data-name="nik"<?php echo $kunjungan->nik->CellAttributes() ?>>
<span id="el_kunjungan_nik">
<span<?php echo $kunjungan->nik->ViewAttributes() ?>>
<?php echo $kunjungan->nik->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kunjungan->atmid->Visible) { // atmid ?>
	<tr id="r_atmid">
		<td class="col-sm-2"><span id="elh_kunjungan_atmid"><?php echo $kunjungan->atmid->FldCaption() ?></span></td>
...
<?php echo $kunjungan->atmid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kunjungan->d_kunjungan->Visible) { // d_kunjungan ?>
	<tr id="r_d_kunjungan">
		<td class="col-sm-2"><span id="elh_kunjungan_d_kunjungan"><?php echo $kunjungan->d_kunjungan->FldCaption() ?></span></td>
...
<?php echo $kunjungan->d_kunjungan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kunjungan->foto1->Visible) { // foto1 ?>
	<tr id="r_foto1">
		<td class="col-sm-2"><span id="elh_kunjungan_foto1"><?php echo $kunjungan->foto1->FldCaption() ?></span></td>
		<td data-name="foto1"<?php echo $kunjungan->foto1->CellAttributes() ?>>
<span id="el_kunjungan_foto1">
<span<?php echo $kunjungan->foto1->ViewAttributes() ?>>
<?php echo ew_GetFileViewTag($kunjungan->foto1, $kunjungan->foto1->ViewValue) ?>
</span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kunjungan->foto2->Visible) { // foto2 ?>
	<tr id="r_foto2">
		<td class="col-sm-2"><span id="elh_kunjungan_foto2"><?php echo $kunjungan->foto2->FldCaption() ?></span></td>
		<td data-name="foto2"<?php echo $kunjungan->foto2->CellAttributes() ?>>
<span id="el_kunjungan_foto2">
<span<?php echo $kunjungan->foto2->ViewAttributes() ?>>
<?php echo ew_GetFileViewTag($kunjungan->foto2, $kunjungan->foto2->ViewValue) ?>
</span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($kunjungan->foto3->Visible) { // foto3 ?>
	<tr id="r_foto3">
		<td class="col-sm-2"><span id="elh_kunjungan_foto3"><?php echo $kunjungan->foto3->FldCaption() ?></span></td>
		<td data-name="foto3"<?php echo $kunjungan->foto3->CellAttributes() ?>>
<span id="el_kunjungan_foto3">
<span<?php echo $kunjungan->foto3->ViewAttributes() ?>>
<?php echo ew_GetFileViewTag($kunjungan->foto3, $kunjungan->foto3->ViewValue) ?>
</span>
</span>
</td>
	</tr>
