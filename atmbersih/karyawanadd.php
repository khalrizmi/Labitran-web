...
class ckaryawan_add extends ckaryawan {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["nik"] != "") {
				...
				$this->setKey("nik", $this->nik->CurrentValue); // Set up key
			} else {
				$this->setKey("nik", ""); // Clear key
	...
	function LoadDefaultValues() {
		...
		$this->lokasid->CurrentValue = NULL;
		$this->lokasid->OldValue = $this->lokasid->CurrentValue;
	...
	function NewRow() {
		...
		$row['lokasid'] = $this->lokasid->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// kode_jabatan
		$this->kode_jabatan->SetDbValueDef($rsnew, $this->kode_jabatan->CurrentValue, NULL, FALSE);
		...
		// lokasid
		$this->lokasid->SetDbValueDef($rsnew, $this->lokasid->CurrentValue, NULL, FALSE);
		...
		if ($bInsertRow && $this->ValidateKey && strval($rsnew['nik']) == "") {
...
fkaryawanadd.Lists["x_kode_jabatan"] = {"LinkField":"x_c_jabatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_n_jabatan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"jabatan"};
fkaryawanadd.Lists["x_kode_jabatan"].Data = "<?php echo $karyawan_add->kode_jabatan->LookupFilterQuery(FALSE, "add") ?>";
fkaryawanadd.AutoSuggests["x_kode_jabatan"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $karyawan_add->kode_jabatan->LookupFilterQuery(TRUE, "add"))) ?>;
fkaryawanadd.Lists["x_lokasid"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_n_lokasi","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"lokasi_kerja"};
fkaryawanadd.Lists["x_lokasid"].Data = "<?php echo $karyawan_add->lokasid->LookupFilterQuery(FALSE, "add") ?>";
...
<?php if ($karyawan->nik->Visible) { // nik ?>
	<div id="r_nik" class="form-group">
		<label id="elh_karyawan_nik" for="x_nik" class="<?php echo $karyawan_add->LeftColumnClass ?>"><?php echo $karyawan->nik->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $karyawan_add->RightColumnClass ?>"><div<?php echo $karyawan->nik->CellAttributes() ?>>
<span id="el_karyawan_nik">
<input type="text" data-table="karyawan" data-field="x_nik" name="x_nik" id="x_nik" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($karyawan->nik->getPlaceHolder()) ?>" value="<?php echo $karyawan->nik->EditValue ?>"<?php echo $karyawan->nik->EditAttributes() ?>>
</span>
...
<?php if ($karyawan->kode_jabatan->Visible) { // kode_jabatan ?>
	<div id="r_kode_jabatan" class="form-group">
		<label id="elh_karyawan_kode_jabatan" class="<?php echo $karyawan_add->LeftColumnClass ?>"><?php echo $karyawan->kode_jabatan->FldCaption() ?></label>
		<div class="<?php echo $karyawan_add->RightColumnClass ?>"><div<?php echo $karyawan->kode_jabatan->CellAttributes() ?>>
...
<script type="text/javascript">
fkaryawanadd.CreateAutoSuggest({"id":"x_kode_jabatan","forceSelect":false});
</script>
</span>
...
<?php if ($karyawan->nama->Visible) { // nama ?>
	<div id="r_nama" class="form-group">
		<label id="elh_karyawan_nama" for="x_nama" class="<?php echo $karyawan_add->LeftColumnClass ?>"><?php echo $karyawan->nama->FldCaption() ?></label>
...
<?php if ($karyawan->telp->Visible) { // telp ?>
	<div id="r_telp" class="form-group">
		<label id="elh_karyawan_telp" for="x_telp" class="<?php echo $karyawan_add->LeftColumnClass ?>"><?php echo $karyawan->telp->FldCaption() ?></label>
		<div class="<?php echo $karyawan_add->RightColumnClass ?>"><div<?php echo $karyawan->telp->CellAttributes() ?>>
...
<?php if ($karyawan->lokasid->Visible) { // lokasid ?>
	<div id="r_lokasid" class="form-group">
		<label id="elh_karyawan_lokasid" for="x_lokasid" class="<?php echo $karyawan_add->LeftColumnClass ?>"><?php echo $karyawan->lokasid->FldCaption() ?></label>
		<div class="<?php echo $karyawan_add->RightColumnClass ?>"><div<?php echo $karyawan->lokasid->CellAttributes() ?>>
...
<?php if ($karyawan->foto->Visible) { // foto ?>
	<div id="r_foto" class="form-group">
		<label id="elh_karyawan_foto" class="<?php echo $karyawan_add->LeftColumnClass ?>"><?php echo $karyawan->foto->FldCaption() ?></label>
		<div class="<?php echo $karyawan_add->RightColumnClass ?>"><div<?php echo $karyawan->foto->CellAttributes() ?>>
