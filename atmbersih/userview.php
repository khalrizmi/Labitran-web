...
<?php if ($user->_userid->Visible) { // userid ?>
	<tr id="r__userid">
		<td class="col-sm-2"><span id="elh_user__userid"><?php echo $user->_userid->FldCaption() ?></span></td>
...
<?php echo $user->_userid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($user->username->Visible) { // username ?>
	<tr id="r_username">
		<td class="col-sm-2"><span id="elh_user_username"><?php echo $user->username->FldCaption() ?></span></td>
...
<?php echo $user->username->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
