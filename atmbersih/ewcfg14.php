...
define("EW_PROJECT_NAME", "projectMonAtm", TRUE); // Project name

define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name

define("EW_PROJECT_ID", "{BEE67E43-43CB-4F70-9480-D7A4451BD8C8}", TRUE); // Project ID (GUID)

$EW_RELATED_PROJECT_ID = "";

$EW_RELATED_LANGUAGE_FOLDER = "";

define("EW_RANDOM_KEY", 't2I139tXiBH4FaJ4', TRUE); // Random key for encryption

define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/projectMonAtm.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "atmbersih", "qs" => "`", "qe" => "`");
...
define("EW_ADMIN_PASSWORD", "atm123", TRUE); // Administrator password
...
define("EW_USER_TABLE", "`user`", TRUE);
