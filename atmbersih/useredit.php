...
<?php if ($user->_userid->Visible) { // userid ?>
	<div id="r__userid" class="form-group">
		<label id="elh_user__userid" class="<?php echo $user_edit->LeftColumnClass ?>"><?php echo $user->_userid->FldCaption() ?></label>
		<div class="<?php echo $user_edit->RightColumnClass ?>"><div<?php echo $user->_userid->CellAttributes() ?>>
...
<input type="hidden" data-table="user" data-field="x__userid" name="x__userid" id="x__userid" value="<?php echo ew_HtmlEncode($user->_userid->CurrentValue) ?>">
<?php echo $user->_userid->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($user->username->Visible) { // username ?>
	<div id="r_username" class="form-group">
		<label id="elh_user_username" for="x_username" class="<?php echo $user_edit->LeftColumnClass ?>"><?php echo $user->username->FldCaption() ?></label>
		<div class="<?php echo $user_edit->RightColumnClass ?>"><div<?php echo $user->username->CellAttributes() ?>>
<span id="el_user_username">
<input type="text" data-table="user" data-field="x_username" name="x_username" id="x_username" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($user->username->getPlaceHolder()) ?>" value="<?php echo $user->username->EditValue ?>"<?php echo $user->username->EditAttributes() ?>>
</span>
...
<?php if ($user->password->Visible) { // password ?>
	<div id="r_password" class="form-group">
		<label id="elh_user_password" for="x_password" class="<?php echo $user_edit->LeftColumnClass ?>"><?php echo $user->password->FldCaption() ?></label>
		<div class="<?php echo $user_edit->RightColumnClass ?>"><div<?php echo $user->password->CellAttributes() ?>>
<span id="el_user_password">
<input type="text" data-table="user" data-field="x_password" name="x_password" id="x_password" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($user->password->getPlaceHolder()) ?>" value="<?php echo $user->password->EditValue ?>"<?php echo $user->password->EditAttributes() ?>>
</span>
