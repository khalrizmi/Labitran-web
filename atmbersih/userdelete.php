...
<?php if ($user->_userid->Visible) { // userid ?>
		<th class="<?php echo $user->_userid->HeaderCellClass() ?>"><span id="elh_user__userid" class="user__userid"><?php echo $user->_userid->FldCaption() ?></span></th>
<?php } ?>
<?php if ($user->username->Visible) { // username ?>
		<th class="<?php echo $user->username->HeaderCellClass() ?>"><span id="elh_user_username" class="user_username"><?php echo $user->username->FldCaption() ?></span></th>
<?php } ?>
<?php if ($user->password->Visible) { // password ?>
		<th class="<?php echo $user->password->HeaderCellClass() ?>"><span id="elh_user_password" class="user_password"><?php echo $user->password->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
