...
fuseradd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($user_add->IsModal) ?>">
...
<?php if ($user->username->Visible) { // username ?>
	<div id="r_username" class="form-group">
		<label id="elh_user_username" for="x_username" class="<?php echo $user_add->LeftColumnClass ?>"><?php echo $user->username->FldCaption() ?></label>
...
<?php if ($user->password->Visible) { // password ?>
	<div id="r_password" class="form-group">
		<label id="elh_user_password" for="x_password" class="<?php echo $user_add->LeftColumnClass ?>"><?php echo $user->password->FldCaption() ?></label>
